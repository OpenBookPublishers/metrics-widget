                    ...
                    <h1 className="text-lg bold p-4">Measures</h1>
                    {
                        data.map((measure) => (
                            <Disclosure>
                                {({ open }) => (
                                    <>
                                        <Disclosure.Button className="flex justify-between w-full px-4 py-2 text-sm border-1 border-blue-600 font-medium text-left text-blue-600 bg-white rounded-lg hover:bg-blue-100 focus:outline-none focus-visible:ring focus-visible:ring-blue-600 focus-visible:ring-opacity-75">
