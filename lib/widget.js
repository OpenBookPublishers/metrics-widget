            ...
            <div className='bg-gray-100 w-full bg-white text-gray-800 overflow-hidden border-2 border-gray-200 rounded-2xl'>
                ...
                <div className='flex bg-white'>
                    <div className='flex-1 group'>
                        ...
                        >
                            <span className='block px-1'>
                                <ChartBarIcon className='h-8 w-8 lg:h-6 lg:w-6 pt-1 mb-1 mx-auto block' aria-label="Measures" />
                    ...
                    <div className='flex-1 group'>
                        ...
                        >
                            <span className='block px-1'>
                                <TrendingUpIcon className='h-8 w-8 lg:h-6 lg:w-6 pt-1 mb-1 mx-auto block' aria-label="Timeline" />
                                <span className='lg:block text-xs pb-1 hidden'>
                                    Timeline
                                </span>
                            </span>
                    ...
                    <div className='flex-1 group'>
                        ...
                        >
                            <span className='block px-1'>
                                <GlobeIcon className='h-8 w-8 lg:h-6 lg:w-6 pt-1 mb-1 mx-auto block' aria-label="Geographical" />
                                <span className='lg:block text-xs pb-1 hidden'>
                                    Geographical
                                </span>
                            </span>
                        ...
                        <div
                            ...
                            className={`${
                                this.state.tab === "info"
                                    ? "text-blue-600 border-blue-600"
                                    : "text-gray-500 border-transparent"
                            } flex items-end justify-center text-center mx-auto cursor-pointer lg:px-4 py-2  w-full group-hover:text-blue-600 border-b-2 border-transparent group-hover:border-blue-600`}
                        >
                            <span className='block px-1'>
                                <InformationCircleIcon className='h-8 w-8 lg:h-6 lg:w-6 pt-1 mb-1 mx-auto block' aria-label="Information" />
                                <span className='lg:block text-xs pb-1 hidden'>
                                    Information
                                </span>
                            </span>
                    ...
                    {this.props.fullReportUrl && (
                        <div className='flex-1 group'>
                            <a
                                ...
                                tabIndex="0"
                                role="link"
                                className='flex items-end justify-center text-center mx-auto cursor-pointer lg:px-4 py-2 w-full text-gray-500 group-hover:text-blue-600 border-b-2 border-transparent group-hover:border-blue-600'
                            >
                                <span className='block px-1'>
                                    <DocumentReportIcon className='h-8 w-8 lg:h-6 lg:w-6 pt-1 mb-1 mx-auto block' aria-label="Full Report" />
                                    <span className='lg:block text-xs pb-1 hidden'>
                                        Full Report
                                    </span>
                                </span>
